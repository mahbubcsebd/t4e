...
import { CheckCircle2, ArrowRight, Target, Layers } from "lucide-react";
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
            ...
            <div className="order-2 md:order-1">
              ...
              <ul className="space-y-4">
                {list.map((item, idx) => (
                  <li key={idx} className="flex items-start gap-3 text-sm sm:text-base font-semibold text-foreground">
