        ...
        <div className="bg-card rounded-xl p-6 md:p-10 w-full relative z-10 border border-border/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex-1 gemini-card rounded-xl overflow-hidden flex flex-col group">
              {/* Visual Canvas */}
              <div className="min-h-[280px] bg-slate-50/50 relative overflow-hidden flex flex-col items-center justify-center p-6 border-b border-border/50">
                <div className="relative w-full max-w-[300px] h-full flex items-center justify-center">
                  {/* Background Nodes */}
                  <div className="absolute top-2 left-2 p-4 bg-primary/10 text-primary rounded-xl border border-primary/20 opacity-60 group-hover:opacity-100 group-hover:-translate-y-2 transition-all duration-700 delay-100 z-10">
                    <Database className="w-6 h-6 sm:w-8 sm:h-8" />
                  </div>
                  <div className="absolute bottom-2 left-[15%] p-4 bg-muted text-muted-foreground rounded-xl border border-border opacity-60 group-hover:opacity-100 group-hover:translate-y-2 transition-all duration-700 delay-200 z-10">
                    <Layout className="w-6 h-6 sm:w-8 sm:h-8" />
                  </div>
                  <div className="absolute top-[20%] right-2 p-4 bg-primary/10 text-primary rounded-xl border border-primary/20 opacity-60 group-hover:opacity-100 group-hover:-translate-x-2 transition-all duration-700 delay-300 z-10">
                    <Network className="w-6 h-6 sm:w-8 sm:h-8" />
                  </div>

                  {/* Center Magnifying Glass / Focus */}
                  <div className="relative z-20 w-20 h-20 sm:w-24 sm:h-24 bg-card/90 backdrop-blur-md rounded-full shadow-lg shadow-primary/20 border-[3px] border-primary/30 flex items-center justify-center group-hover:scale-110 transition-transform duration-500">
            ...
            <div className="flex-1 gemini-card rounded-xl overflow-hidden flex flex-col group">
              <div className="min-h-[280px] bg-slate-50/50 relative overflow-hidden flex items-center justify-center p-6 border-b border-border/50">
              ...
              <div className="min-h-[280px] bg-slate-50/50 relative overflow-hidden flex items-center justify-center p-6 border-b border-border/50">
                <div className="flex flex-col gap-4 sm:gap-5 w-40 sm:w-48">
                  <div className="flex items-center justify-between p-3 sm:p-4 bg-muted border border-border rounded-lg group-hover:-translate-x-1 transition-transform duration-500">
                    <div className="w-20 sm:w-24 h-2.5 sm:h-3 rounded-full bg-slate-200"></div>
                  ...
                  <div className="flex items-center justify-between p-3 sm:p-4 bg-muted border border-border rounded-lg group-hover:translate-x-1 transition-transform duration-500 delay-75">
                    <div className="w-10 sm:w-12 h-2.5 sm:h-3 rounded-full bg-slate-200"></div>
                    <ToggleRight className="w-6 h-6 sm:w-8 sm:h-8 text-slate-300 group-hover:text-primary transition-colors delay-100" />
                  </div>
                </div>
              </div>
              <div className="p-8 sm:p-10 flex-1 bg-transparent flex flex-col">
