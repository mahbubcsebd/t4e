        ...
        <div className="bg-card rounded-xl p-6 md:p-10 w-full relative z-10 border border-border/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="gemini-card rounded-xl overflow-hidden flex flex-col group">
              ...
              <div className="min-h-[280px] bg-slate-50/50 border-b border-border/50 relative p-6 flex flex-col items-center justify-center overflow-hidden">
                <div className="flex flex-col gap-4 relative z-10 w-full max-w-[200px]">
                  ...
                  {/* Layer 2: Workflows */}
                  <div className="bg-card border border-border rounded-xl p-3 flex items-center gap-3 relative z-10 shadow-sm group-hover:translate-x-2 transition-transform duration-500 delay-75 ml-4">
                  ...
                  {/* Layer 3: Decisions */}
                  <div className="bg-card border border-border rounded-xl p-3 flex items-center gap-3 relative z-10 shadow-sm group-hover:translate-x-2 transition-transform duration-500 delay-150 ml-8">
            ...
            <div className="gemini-card rounded-xl overflow-hidden flex flex-col group">
              {/* Visual Canvas */}
              <div className="min-h-[280px] bg-slate-50/50 border-b border-border/50 relative p-6 flex flex-col items-center justify-center overflow-hidden">
                <div className="w-full max-w-xs relative flex flex-col items-center justify-center gap-6">
                  
                  {/* Local Change Node */}
                  <div className="relative z-10 bg-card px-4 py-2.5 rounded-full border border-primary/30 shadow-md shadow-primary/10 flex items-center gap-2 group-hover:-translate-y-1 transition-transform duration-500">
                  ...
                  {/* Connecting lines */}
                  <div className="relative w-full max-w-[180px] h-8">
                    <div className="absolute left-1/2 top-0 bottom-0 w-[2px] bg-border -translate-x-1/2"></div>
                    <div className="absolute left-0 right-0 top-1/2 h-[2px] bg-border"></div>
                    <div className="absolute left-0 top-1/2 bottom-0 w-[2px] bg-border"></div>
                    <div className="absolute right-0 top-1/2 bottom-0 w-[2px] bg-border"></div>
                  </div>
