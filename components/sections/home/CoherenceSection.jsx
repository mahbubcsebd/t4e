      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-5xl mx-auto bg-white rounded-3xl border border-zinc-200 shadow-[0_20px_40px_rgb(9,60,173,0.06)] overflow-hidden flex flex-col group">
          ...
          <div className="flex flex-col lg:flex-row relative items-stretch">
            ...
            <div className="hidden lg:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 bg-white border border-zinc-200 rounded-full items-center justify-center z-20 shadow-sm text-[10px] font-bold text-zinc-400">
               VS
            </div>
            ...
            <div className="flex-1 p-8 lg:p-12 border-b lg:border-b-0 lg:border-r border-zinc-100 bg-gradient-to-br from-emerald-50/40 to-transparent flex flex-col">
              ...
              <div className="bg-white border border-emerald-200/60 rounded-2xl p-6 shadow-sm relative group-hover:-translate-y-1 transition-transform duration-500 flex-1">
                ...
                <strong className="text-lg sm:text-xl font-bold text-[#09090d] block mb-3 leading-snug">
            ...
            <div className="flex-1 p-8 lg:p-12 bg-gradient-to-bl from-rose-50/40 to-transparent flex flex-col">
              ...
              <div className="bg-white border border-rose-200/60 rounded-2xl p-6 shadow-sm font-mono relative overflow-hidden group-hover:-translate-y-1 transition-transform duration-500 delay-75 flex-1">
                ...
                <div className="flex items-center gap-4 text-[11px] text-rose-500/70 mb-3 tracking-wider uppercase font-sans font-bold">
            ...
            <div className="bg-rose-50 border border-rose-200 rounded-2xl p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 shadow-sm shadow-rose-100/50">
              <div className="flex items-start sm:items-center gap-4">
                ...
                <div>
                  ...
                  <strong className="text-sm sm:text-base font-bold text-rose-950 block">
                    {t("coherence.alertTitle")}
                  </strong>
                </div>
              </div>
              <div className="bg-white border border-rose-200 text-rose-700 text-[11px] font-bold px-4 py-2.5 rounded-lg whitespace-nowrap shadow-sm flex items-center gap-2 hover:bg-rose-600 hover:text-white hover:border-rose-600 transition-colors cursor-pointer">
            ...
            <div className="flex flex-col gap-6 relative z-10">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
                {impactNodes.map((node, i) => (
                  <div key={i} className="bg-white border border-slate-200 rounded-xl p-3 pr-4 flex items-center gap-3 shadow-sm hover:border-[#07A7E1] hover:shadow-md transition-all cursor-default group/node">
