            ...
            <div className="max-w-7xl mx-auto bg-card rounded-xl border border-border shadow-lg shadow-black/5 overflow-hidden flex flex-col group">
              ...
              <div className="flex flex-col lg:flex-row relative items-stretch">
                ...
                <div className="flex-1 p-5 sm:p-8 lg:p-12 border-b lg:border-b-0 lg:border-r border-border bg-gradient-to-br from-primary/10 to-transparent flex flex-col">
                  ...
                  <div className="gemini-card rounded-xl p-5 sm:p-6 relative group-hover:-translate-y-1 transition-transform duration-500 flex-1 border border-primary/50 shadow-sm shadow-primary/5">
                ...
                <div className="flex-1 p-5 sm:p-8 lg:p-12 bg-gradient-to-bl from-muted/40 to-transparent flex flex-col">
                  ...
                  <div className="gemini-card rounded-xl p-5 sm:p-6 font-mono relative overflow-hidden group-hover:-translate-y-1 transition-transform duration-500 delay-75 flex-1 border border-red-500/50 shadow-sm shadow-red-500/5">
