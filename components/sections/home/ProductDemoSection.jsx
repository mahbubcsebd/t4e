...
export default function ProductDemoSection() {
  ...
  return (
    <section
      ...
      id="resources"
    >
      <div className="bg-slate-100 dark:bg-slate-900/50 rounded-xl border border-border overflow-hidden relative max-w-[1400px] mx-auto p-4 md:p-5 transition-colors duration-300">
