...
export default function ProductDemoSection() {
  ...
  return (
    <section className="p-5" id="resources">
      <div className="bg-black/[0.05] dark:bg-white/[0.02] rounded-xl border border-border overflow-hidden relative max-w-[1400px] mx-auto p-4 md:p-5 transition-colors duration-300">
