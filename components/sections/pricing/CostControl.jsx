              ...
              return (
                ...
                >
                  <div className="relative z-10 flex flex-col items-start">
                    <div className="mb-6 p-4 rounded-2xl bg-muted border border-border transition-all duration-500 group-hover:scale-110 shadow-sm group-hover:shadow-primary/10">
                      <Icon className="w-7 h-7 text-foreground transition-colors duration-300" />
                    </div>
