            ...
            {cards.map((c, idx) => (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center flex-grow">
                  <div className="mb-5 p-4 rounded-full bg-muted border border-border shadow-[0_0_30px_rgba(var(--primary),0.15)] group-hover:shadow-[0_0_40px_rgba(var(--primary),0.3)] transition-all duration-500 group-hover:scale-110">
                    {c.icon}
                  </div>
                  <span className="mb-4 text-[10px] font-extrabold text-foreground bg-muted px-3 py-1 rounded-full uppercase tracking-[0.2em] border border-border group-hover:border-border transition-colors">
                    {c.tag}
                  </span>
