      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {cards.map((c, idx) => (
            <div
              key={idx}
              className="bg-[#f9fcff] border border-[#c8d9ed] rounded-2xl p-7 hover:border-[#093cad] transition-all hover:shadow-lg flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="p-2.5 rounded-xl bg-white border border-[#c8d9ed]">
                    {c.icon}
                  </div>
                </div>
              ...
              <ul className="space-y-2 pt-4 border-t border-[#c8d9ed]/50 text-xs font-semibold text-[#09090d]">
                {c.list.map((item, i) => (
