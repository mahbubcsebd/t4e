...
export default function BlogGridSection() {
  ...
  return (
    <>
      {/* Blog Hero Section */}
      <section className="py-16 md:py-24 bg-background from-white via-[#f7fafe] to-white border-b border-border text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <span className="inline-block px-3 py-1 rounded-full bg-primary/10 text-primary text-xs font-bold uppercase tracking-wider mb-6 border border-primary/20 shadow-sm">
            {t("blogPage.heroEyebrow")}
          </span>

          <h1 className="max-w-[800px] mx-auto text-4xl sm:text-5xl md:text-6xl font-extrabold text-foreground tracking-tight leading-[1.15] mb-6">
            {t("blogPage.heroTitlePrefix")}{" "}
            <span className="text-primary decoration-primary/30">
              {t("blogPage.heroTitleHighlight")}
            </span>
          </h1>

          <p className="max-w-[650px] text-base sm:text-lg text-muted-foreground mx-auto leading-relaxed">
