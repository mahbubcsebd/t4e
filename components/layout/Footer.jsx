    ...
    <footer className="bg-background border-t border-border pt-16 pb-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="md:col-span-4 lg:col-span-5 flex flex-col items-start gap-5">
            ...
            <div className="flex items-center gap-3 mt-1">
              <a
                ...
                className="w-10 h-10 rounded-full bg-muted border border-border flex items-center justify-center text-slate-600 dark:text-slate-300 hover:text-primary hover:bg-primary/10 hover:border-primary transition-all duration-300"
              >
        ...
        <div className="mt-16 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-600 dark:text-slate-300/70 font-medium">
            {t("footer.copyright")}
          </p>
          {/* Gradient badge */}
